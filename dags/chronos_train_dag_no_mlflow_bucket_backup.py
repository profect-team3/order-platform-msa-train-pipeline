...
@dag(
    dag_id="chronos_train_dag_no_mlflow_with_bucket_backup",
    schedule=None,
    ...
    def train_model(train_data_df):
        ...
        try:
            ...
            predictor = TimeSeriesPredictor(
                ...
                time_limit=120,  # 300 seconds (5 minutes)
    ...
    def predict(model_info, train_data_df):  # Changed model_path to model_info
        ...
        try:
            ...
            for blob_name in blobs:
                ...
                # Skip if the blob_name is the prefix itself (i.e., a directory)
                if relative_path == '.':
                    logging.info(f"Skipping directory blob: {blob_name}")
                    continue
